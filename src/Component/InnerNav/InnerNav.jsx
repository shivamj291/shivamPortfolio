  ...
  const { hasCopied, onCopy, setValue } = useClipboard("");
    return(
        ...
        <div id={style.Navbar} style={flag ? {padding:"25px"} : {padding:"5px"}}>
            ...
            <div id={style.resume}>
              <a href="/shivam_jaiswal.pdf" target="_blank">  <Button width='200px' height='50px' background='transparent' border='2px solid' borderRadius='50px' id={style.navCv}>RESUME</Button></a>
