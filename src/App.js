...
function App() {
  ...
  return (
    ...
    {backgroundImage:'url(https://images.pexels.com/photos/2528118/pexels-photo-2528118.jpeg?auto=compress&cs=tinysrgb&w=600)',backgroundAttachment:'fixed',backgroundSize:'cover'}
